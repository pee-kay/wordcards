(function (global) {
    ...
    const STRINGS = {
        en: {
            ...
            'strokes.showStepNumbers': 'Show step numbers',
            'strokes.practiceRows': 'Add practice rows',
            'strokes.practiceRowsCount': 'Practice rows to add',
        ...
        ru: {
            ...
            'radicals.showPinyin': 'Показывать пиньинь под каждой ячейкой',
            ...
            'strokes.showStepNumbers': 'Показывать номера шагов',
            'strokes.practiceRows': 'Добавить строки для тренировки',
            'strokes.practiceRowsCount': 'Число тренировочных строк',
