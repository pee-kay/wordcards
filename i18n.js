(function (global) {
    ...
    const STRINGS = {
        en: {
            ...
            'mc.qMeaning': 'Which option means «{meaning}»?',
            'mc.qPron': 'What is pronounced «{pron}»?',
            ...
            'mc.simplMode': 'Simpler',
            'mc.hardMode': 'Harder',
            'mc.hardModeGroup': 'Multiple choice difficulty',
            ...
            'ws.useHanziQuiz': 'Use HanziWriter handwriting quiz',
            'ws.qMeaning': 'How do you write «{meaning}»?',
            'ws.qPron': 'How do you write «{pron}»?',
            'ws.correct': 'Correct!',
            'ws.wrong': 'The correct answer was supposed to be the word {word}.',
            'ws.hwStrokeHint': 'Stroke {cur} out of {total}',
            'ws.noHanziInWord': 'This word has no Chinese characters to quiz.',
            ...
            'radicals.columns': 'Number of columns',
            'radicals.shuffle': 'Shuffle character order',
            'radicals.showPinyin': 'Show pinyin below each cell',
            ...
            'strokes.showMeta': 'Show pinyin and/or translation',
            'strokes.showStepNumbers': 'Enumerate strokes',
            'strokes.practiceRows': 'Practice rows',
            'strokes.practiceRowsCount': 'Number of rows',
            ...
            'wl.redo': 'Redo',
            'wl.sort': 'Sort',
            'wl.sortPinyinSize': 'By pinyin (by size)',
            'wl.sortPinyin': 'By pinyin',
            'wl.sortTranslation': 'By translation',
            'wl.sortRadical': 'By radical',
            'wl.sortWordSizeStable': 'By word length (keep order)',
            'wl.viewAsCsv': 'Edit as CSV',
            'wl.viewAsTable': 'Back to table',
            'wl.csvEditorPlaceholder': 'word,pinyin,translation — one row per line',
            'wl.missingMorphemes': 'Missing morphemes',
            'wl.addAllSuggestions': 'Add all (first suggestion per row)',
            'wl.clearAddInput': 'Clear',
            'wl.dedup': 'Deduplicate',
            'wl.exportCsv': 'Export CSV',
            'wl.exportCsvFilenamePrompt': 'File name for download:',
            'wl.importCsv': 'Import CSV',
            'wl.copyClipboard': 'Copy to clipboard',
            'wl.loadClipboard': 'Load from clipboard',
            'wl.importAsk': 'How should the data be loaded?',
            'wl.importReplace': 'Replace list',
            'wl.importAppend': 'Add to end',
            'wl.importCancel': 'Cancel',
            ...
            'wl.thematicFilterPlaceholder': 'Filter: pinyin, Chinese, or translation',
            'wl.thematicFilterAria': 'Filter words in the thematic list',
            'wl.table': 'Word list',
            'wl.colNum': '#',
            'wl.colWord': 'Word',
            'wl.colPinyin': 'Pinyin',
            ...
            'wl.rowHandleTitle': 'Drag to move this row',
        ...
        ru: {
            ...
            'mc.qMeaning': 'Какой вариант означает «{meaning}»?',
            'mc.qPron': 'Что произносится как «{pron}»?',
            ...
            'mc.simplMode': 'Легче',
            'mc.hardMode': 'Сложнее',
            'mc.hardModeGroup': 'Сложность вопросов с выбором ответа',
            ...
            'ws.useHanziQuiz': 'Использовать рукописный квиз HanziWriter',
            'ws.qMeaning': 'Как написать «{meaning}»?',
            'ws.qPron': 'Как написать «{pron}»?',
            'ws.correct': 'Верно!',
            'ws.wrong': 'Правильным ответом предполагалось слово {word}.',
            'ws.hwStrokeHint': 'Черта {cur} из {total}',
            'ws.noHanziInWord': 'В этом слове нет китайских иероглифов для квиза.',
            ...
            'radicals.subtitle':
                'Генератор упражения для вставки пропущенных черт и/или ключей. В каждой клетке - иероглиф с рядом пропущенных черт (для отображения используются данные о начертании иероглифов из <a href="https://hanziwriter.org/" rel="noopener noreferrer">Hanzi Writer</a>).',
            ...
            'radicals.columns': 'Число столбцов',
            'radicals.shuffle': 'Перемешать порядок иероглифов',
            'radicals.showPinyin': 'Показывать пиньинь под каждой клеткой',
            ...
            'radicals.warnNoHw':
                'Hanzi Writer не загрузился; для всех клеток используется простая маска (нужен скрипт библиотеки).',
            'radicals.warnStrokeFallback':
                '',
            'radicals.warnRadicalFallback':
            ...
            'strokes.showMeta': 'Показывать пиньинь и/или перевод',
            'strokes.showStepNumbers': 'Нумеровать черты',
            'strokes.practiceRows': 'Cтроки для тренировки',
            'strokes.practiceRowsCount': 'Число строк',
            ...
            'wl.redo': 'Повторить',
            'wl.sort': 'Сортировать',
            'wl.sortPinyinSize': 'По пиньинь (по длине)',
            'wl.sortPinyin': 'По пиньинь',
            'wl.sortTranslation': 'По переводу',
            'wl.sortRadical': 'По ключу (радикалу)',
            'wl.sortWordSizeStable': 'По длине слова (сохранить порядок)',
            'wl.viewAsCsv': 'Редактировать как CSV',
            'wl.viewAsTable': 'Вернуться к таблице',
            'wl.csvEditorPlaceholder': 'слово,пиньинь,перевод — по одной строке',
            'wl.missingMorphemes': 'Недостающие морфемы',
            'wl.addAllSuggestions': 'Добавить все (первый вариант в каждой строке)',
            'wl.clearAddInput': 'Очистить',
            'wl.dedup': 'Убрать дубликаты',
            'wl.exportCsv': 'Экспорт CSV',
            'wl.exportCsvFilenamePrompt': 'Имя файла для сохранения:',
            'wl.importCsv': 'Импорт CSV',
            'wl.copyClipboard': 'Скопировать',
            'wl.loadClipboard': 'Вставить из буфера',
            'wl.importAsk': 'Как загрузить данные?',
            'wl.importReplace': 'Заменить список',
            'wl.importAppend': 'Добавить в конец',
            'wl.importCancel': 'Отмена',
            ...
            'wl.thematicFilterPlaceholder': 'Фильтр: пиньинь, иероглифы или перевод',
            'wl.thematicFilterAria': 'Фильтр слов в тематическом списке',
            ...
            'wl.rowHandleTitle': 'Перетащите, чтобы переместить строку',
